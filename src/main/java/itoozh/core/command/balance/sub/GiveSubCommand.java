...
public class GiveSubCommand extends BaseSubCommand {
    ...
    public boolean canUser(CommandSender sender) {
        return sender.hasPermission("core.balance.give");
    }
    ...
    public boolean execute(CommandSender sender, String label, String[] args) {
        ...
        targetSession.giveBalance(amount);
        sender.sendMessage(TextFormat.colorize(Main.prefix + "&aYou have given &l" + amount + "$&r&a to " + targetPlayer.getName()));
        return true;
    }
